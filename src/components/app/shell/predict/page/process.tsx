              ...
              {steps.map((step, idx) => {
                ...
                return (
                  <button
                    ...
                    className="min-w-[140px] md:min-w-0 flex-1 shrink-0 flex items-center justify-center gap-2 px-2 hover:bg-neutral-primary/50 h-[48px] md:h-full transition-colors group first:rounded-l-[12px] md:first:rounded-l-full last:rounded-r-[12px] md:last:rounded-r-full snap-center"
                  >
