    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 border-b border-border-default">
        <div className="flex items-center gap-2">
          ...
          <div className="h-4 w-4 rounded-full bg-neutral-secondary flex items-center justify-center text-[10px] text-body-subtle cursor-help" title={t("totalLogsTooltip")}>
            i
          </div>
        </div>
